...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        #增加sr_a,sr_b
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B','SR_A', 'SR_B']
    ...
    def backward_G(self):
        ...
        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + self.loss_SR_A + self.loss_SR_B
        # if self.opt.amp:
