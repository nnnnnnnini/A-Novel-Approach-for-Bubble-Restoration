...
def doit(foldername):
    ...
    input_folder = f"/home/xingzehang/project_100t/tuisexiufu_results/ffpep_cut/test_40/fakeB_fenlei/{foldername}/"
    ouput_folder = "/home/xingzehang/project_100t/tuisexiufu_results/ffpep_cut/test_40/wsi——512/"
    ...
    new_image_result.save(os.path.join(ouput_folder, f"{foldername}_fake_B.png")) #{foldername}_fake_B.png
...
if __name__ == "__main__":
    ...
    path = '/home/xingzehang/project_100t/tuisexiufu_results/ffpep_cut/test_40/fakeB_fenlei/'
